import {  Outlet, useSearchParams, useLocation, useNavigate, Link } from 'react-router-dom';
        ...
        {invoices
          ...
          .map((invoice) => (
            <div
              ...
              onClick={() => {
                navigate(`/info/invoiceId?invoiceId=${invoice.number}&filter=${searchParams.get('filter') || ''}`);
              }}
              key={invoice.number}
            >
              {invoice.name}

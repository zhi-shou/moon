import { useLocation, Outlet, useSearchParams, useLocation, useNavigate, useParams } from 'react-router-dom';
        ...
        {invoices
          ...
          .map((invoice) => (
            <div
              ...
              onClick={() => {
                // setSearchParams({ filter });
                navigate('/info/invoiceId', { state: { invoiceId: invoice.number } });
              }}
              key={invoice.number}
            >
              {invoice.name}
